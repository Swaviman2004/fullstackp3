pipeline {
    ...
    environment {
        ...
        TOMCAT_URL = 'http://43.204.145.202:9090//manager/text'
        TOMCAT_USER = 'admin'
        TOMCAT_PASS = 'admin'
    ...
    stages {
        stage('Clone Repository') {
            steps {
                git url: 'https://github.com/Swaviman2004/fullstackp3.git', branch: 'main'
            }
        }
    ...
    post {
        success {
            echo "✅ Backend deployed: http://43.204.145.202:9090/springapp1"
            echo "✅ Frontend deployed: http://43.204.145.202:9090/frontapp1"
        }
        failure {
